...
public class Logger {
    ...
    public static final String SOURCE_FORMAT_VAR_METHOD = StringSubstitutor.DEFAULT_VAR_START + SOURCE_FORMAT_METHOD + StringSubstitutor.DEFAULT_VAR_END;
    public static final String SOURCE_FORMAT_FILE = "file";
    public static final String SOURCE_FORMAT_VAR_FILE = StringSubstitutor.DEFAULT_VAR_START + SOURCE_FORMAT_FILE + StringSubstitutor.DEFAULT_VAR_END;
    public static final String SOURCE_FORMAT_LINE = "line";
    public static final String SOURCE_FORMAT_VAR_LINE = StringSubstitutor.DEFAULT_VAR_START + SOURCE_FORMAT_LINE + StringSubstitutor.DEFAULT_VAR_END;
