...
public class RethrownException extends CJPException {
    ...
    public RethrownException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
