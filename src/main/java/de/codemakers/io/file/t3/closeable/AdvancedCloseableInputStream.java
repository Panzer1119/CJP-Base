...
public class AdvancedCloseableInputStream extends AdvancedCloseable<Closeable, InputStream> {
    ...
    @Override
    public <R> R close(Function<InputStream, R> function, Consumer<Throwable> failureClosing) throws Exception {
        return super.close(function, failureClosing);
    }
    
    @Override
    public <R> R close(Function<InputStream, R> function, Consumer<Throwable> failureFunction, Consumer<Throwable> failureClosing) {
        return super.close(function, failureFunction, failureClosing);
    }
    
    @Override
    public <R> R closeWithoutException(Function<InputStream, R> function, Consumer<Throwable> failureFunction) {
