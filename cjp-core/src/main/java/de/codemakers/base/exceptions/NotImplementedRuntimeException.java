...
public class NotImplementedRuntimeException extends CJPRuntimeException {
    ...
    public NotImplementedRuntimeException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
